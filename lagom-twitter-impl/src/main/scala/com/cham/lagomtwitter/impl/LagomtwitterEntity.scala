...
/**
  * This is an event sourced entity. It has a state, [[LagomtwitterState]], which
...
class LagomtwitterEntity extends PersistentEntity {
  ...
  override type Command = LagomtwitterCommand[_]
  override type Event = LagomtwitterEvent
  override type State = LagomtwitterState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: LagomtwitterState = LagomtwitterState("Hello", LocalDateTime.now.toString)
...
/**
  ...
  */
case class LagomtwitterState(message: String, timestamp: String)

object LagomtwitterState {
  /**
    ...
    */
  implicit val format: Format[LagomtwitterState] = Json.format
}

/**
  * This interface defines all the events that the LagomtwitterEntity supports.
  */
sealed trait LagomtwitterEvent extends AggregateEvent[LagomtwitterEvent] {
  def aggregateTag = LagomtwitterEvent.Tag
}

object LagomtwitterEvent {
  val Tag = AggregateEventTag[LagomtwitterEvent]
}
...
/**
  ...
  */
sealed trait LagomtwitterCommand[R] extends ReplyType[R]
